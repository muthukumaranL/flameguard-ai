...
| Model: loads and infers on CPU | PASS | CPU inference 2381 ms, empty-path OK |
...
| Report: DOCX opens | PASS | 295 paragraphs, 13 tables, 28 figures |
...
| Submission ZIP: Group5_FlameGuard_AI_Final_Submission.zip | PASS | 692 entries, 216.3 MB, missing=none, forbidden=0 |
